...
pub fn token_name(t: &Token) -> String {
    match t {
        ...
        Token::Grace      => "'grace'".into(),
        Token::Granted    => "'granted'".into(),
        Token::Absent     => "'absent'".into(),
        Token::Verdict    => "'verdict'".into(),
        Token::Righteous  => "'righteous'".into(),
        Token::Condemned  => "'condemned'".into(),
...
fn keyword_or_ident(word: String) -> Token {
    match word.as_str() {
        ...
        "righteous"  => Token::Righteous,
        "condemned"  => Token::Condemned,
        "after"      => Token::After,
        "thus"       => Token::Thus,
        "plus"       => Token::Plus,
        "minus"      => Token::Minus,
